...
class QuickpayTestController {
   ...
   * The reason we have to load it this way, and not using the _form in the route definition,
   * is we need to unset form_id and form_build_id. Read the comment further below.
   *
  ...
  public function checkout($order_id) {
    ...
    // are not a part of our generated checksum, then they should be removed from the form.
    // They are not doing anything anyways, since we are requesting quickpay directly.
